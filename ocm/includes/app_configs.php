...
define('BASE_DOMAIN', 'https://dev.vneu.vn/'); // dia chi cua website,...
define('SEO_DOMAIN', 'https://dev.vneu.vn/'); // dia chi cua website,...
...
define('ROOT_FOLDER', '/home/nhoffcor/dev_vneu/'); // duong dan thu muc goc

...
<div class="login-container">
    	<div class="login-top">
            <div class="login-text"><span>HỆ THỐNG</span><br/><span style="font-size:23px">QUẢN LÝ BACKEND</span></div>
        </div>
        ...
        <div class="login-content">
        	<div class="login-note" id="login-note" style="display:none;"></div>
         	<table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <!--//7-3-2015: Thangnb add o nhap token key -->
                <?php if(KIEM_TRA_OTP) { ?>
                    <tr>
                        <td class="loginLabel" height="32">Token key</td>
                        <td><input class="txt" name="token" maxlength="15" type="token"/></td>
                    </tr>
                <?php } ?>
                <!--//End 7-3-2015: Thangnb add o nhap token key -->
                <tr>

                    ...
                    <td valign="top">
						<table border = 0 width  = "100%">
							<tr>
								...
								<td>
									<input type="text" id="txt_news_name" name="txt_news_name" value="<?php echo $v_news_name?>" title="Nhập tên bài viết" class="auto-title auto-submit" />                        					
								</td>
							</tr>
                            <tr>
								<td valign = "top">ID bài viết</td>
								<td>
									<input type="text" id="txt_news_id" name="txt_news_id" value="<?php echo $v_news_id > 0 ? $v_news_id : ''; ?>" title="Nhập id bài viết" class="auto-title auto-submit" />                        					
								</td>
							</tr>
						</table>
                    </td>        

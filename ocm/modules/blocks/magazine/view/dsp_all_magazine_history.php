...
<div id="div_dsp_all_item">
	<div class="header-popup">Lịch sửa đổi nội dung magazine</div>
	<div class="popupContent">
		<div class="greyBox-light" style="height: 26px;">
			Tên nội dung magazine: <b><?php echo $v_magazine['c_name'];?></b>
		...
		<table width="100%" cellpadding="1" cellspacing="1" border="0" class="listing">
			...
			for ($i=0; $i< $v_count; $i++) {
				$v_id = $v_arr_items[$i]["pk_magazine_history"];
				...
				$v_href_item = html_link($this->className() . "/dsp_single_magazine_history/$v_id?goback=".$goback, false);
				?>

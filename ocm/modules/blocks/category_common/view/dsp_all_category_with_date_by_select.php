...
<form action="<?php echo $v_action; ?>" method="post" name="frm_dsp_all_item" style="padding-top:10px" target="frm_submit">
    ...
    <div style="width:100%;height:300px;margin-bottom:10px;overflow-y:auto">
            ...
            for ($i=0; $i<$v_record_count; $i++) {
                ...
                <tr>
                    <td class="<?php echo $v_class_name1; ?>" align="center">
                        ...
                        <input type="hidden" name="hdn_category_name_<?php echo $i; ?>" value="<?php echo str_replace('&nbsp;&nbsp;&nbsp;&nbsp;', '-- ', $v_category['Name']); ?>" />
                    </td>
	...
	<table width="100%" cellpadding="1" cellspacing="1" border="0" bordercolor="#bbb" style="border-collapse:collapse">          
		<tr>
			<td width="100">Từ ngày</td>
			<td><input type="text" name="txt_tu_ngay" id="txt_tu_ngay" class="frm_dsp_filter_date_select"  style="width:100px;" value="<?php echo $v_arr_date['begin_date']?>"/></td>
		</tr>
		<tr>
			<td>Đến ngày</td>
			<td><input type="text" name="txt_den_ngay" id="txt_den_ngay" class="frm_dsp_filter_date_select"  style="width:100px;" value="<?php echo $v_arr_date['end_date']?>"/></td>
		</tr>
	</table>	
	<br/>
    <?php
...
<script type="text/javascript">setDatePicker("frm_dsp_filter_date_select");</script>

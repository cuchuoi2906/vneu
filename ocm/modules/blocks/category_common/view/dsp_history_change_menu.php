<div id="div_dsp_all_item">
    <div class="contentTitle">LỊCH SỬ SỬA ĐỔI MENU</div>
            ...
            <div class="line-dot"></div>
                <table border="0" width="100%" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                           <?php echo $rs_single_menu['c_name']; ?>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo $rs_single_menu['c_url']; ?>
                        </td>
                    </tr>
                    <tr>
                        <td width="130" class="tbLabel">icon</td>
                        <td>
                            <img src="<?php echo '/'.str_replace('/upload','upload',$rs_single_menu['c_icon']);?>"/>        
                        </td>
                    </tr>
                    <tr>
                        <td width="130" class="tbLabel">Trọng số</td>
                        <td>
                            <?php echo $rs_single_menu['c_ordering']?>        
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo html_select_box('c_sel_publish', $v_arr_trang_thai, 'c_code', 'c_name', $rs_single_menu['published'], $extend=' disabled', $add_option = 0); ?>
                        </td>
                    </tr>
                </table>       
            <?php

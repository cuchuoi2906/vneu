...
<form action="<?php echo $v_action; ?>" method="post" name="frm_dsp_all_item" style="padding-top:10px" target="frm_submit">
    <input type="hidden" id="hdn_is_accept_no" name="hdn_is_accept_no" value="<?php echo $v_is_accept_choose_no_category; ?>" />
	...
	<a class="button_big btn_grey" href="javascript:;" onclick="return frm_submit_select_category(document.frm_dsp_all_item, 'sel_category_list', true,<?php echo $v_is_no_submit; ?>);">Chọn</a>

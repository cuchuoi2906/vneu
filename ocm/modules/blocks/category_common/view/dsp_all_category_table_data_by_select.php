...
<form action="<?php echo $v_action; ?>" method="post" name="frm_dsp_all_item" style="padding-top:10px" target="frm_submit">
	...
	<table width="100%" cellpadding="1" cellspacing="1" border="0" bordercolor="#bbb" style="border-collapse:collapse">          
		<tr>
			...
			<td><input type="text" name="txt_tu_ngay" id="txt_tu_ngay" class="frm_dsp_filter_date_select"  style="width:100px;" value=""/></td>
		</tr>
		<tr>
			<td>Đến ngày</td>
			<td><input type="text" name="txt_den_ngay" id="txt_den_ngay" class="frm_dsp_filter_date_select"  style="width:100px;" value=""/></td>
		</tr>
	</table>	
	<br/>
    <?php
